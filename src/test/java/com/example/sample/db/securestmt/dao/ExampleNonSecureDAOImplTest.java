...
import com.example.sample.db.securestmt.dao.ExampleNonSecureDAOImpl;
import com.example.sample.db.securestmt.dto.ExampleDTO;

@RunWith(SpringRunner.class)
public class ExampleNonSecureDAOImplTest {
	...
	@SpyBean
	ExampleNonSecureDAOImpl exampleNonSecureDAOImpl;
	...
	public void findUserInfoByUserWithValidArgumentsShouldReturnAListWithUserInfo() throws Exception {
		...
		List<ExampleDTO> result = exampleNonSecureDAOImpl.findUserInfoByUser("User1");
	...
	public void findUserInfoByUserWithValidArgumentsShouldThrowASQLExceptionWhenGetConnectionThrowsAnException() throws Exception {
		...
		exampleNonSecureDAOImpl.findUserInfoByUser("User1");				
	}	
}
